...
function submitGuess() {
    ...
    Promise.all([
        ...
        fetch('https://mortipins-dashboard.imenkei64.workers.dev/update-points', {
            ...
            body: JSON.stringify({
                points: points, // Send the calculated points
                correctRank: videoLinks[currentVideoIndex].trueRank, // Send the correct rank
                guessedRank: selectedRankName, // Send the guessed rank
                winStreak: streak // Send the current win streak
            })
        })
